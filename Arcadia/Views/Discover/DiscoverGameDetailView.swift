...
#Preview {
    DiscoverGameDetailView(game: ArcadiaFeaturedGame(id: 0, name: "Awesome game", shortDescription: "This game is awesome", longDescription: """
...
""", developerId: 0, coverImageAssetName: "gbc_icon", itchURL: URL(string: "http://instagram.com")!, screenshotsAssetName: []))
    .frame(height: 700)
}
