...
struct ArcadiaGameFile: FileDocument {
    
    static var readableContentTypes = [UTType(importedAs: "com.davideandreoli.Arcadia.atari2600GameFile")]
